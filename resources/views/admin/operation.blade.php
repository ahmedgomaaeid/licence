      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="row">
                <form class="form" action="{{route('admin.add.operation')}}" method="post">
                    @csrf
            ...
            <div class="row">
                <div class="carts">
                    @foreach ($operations as $operation)
                        <div class="cart">
                            <p> الاسم : {{$operation->name}}</p>
                            <p>  اسم المستخدم : {{$operation->username}}</p>
                            <a class="sign-but rej" href="{{route('admin.delete.operation',$operation->id)}}">حذف</a>
                        </div>
                    @endforeach
                </div>
            </div>
